...
void ChangeSceneLoad_04(DWORD_PTR, DWORD_PTR);
void ExitGame_04(DWORD_PTR, DWORD_PTR);
void ResumeGame_04(DWORD_PTR, DWORD_PTR);

bool bSettingOn_04 = false;

CScene_Stage_04::CScene_Stage_04()
{
...
// 	}
	...
	if (KEY_TAP(KEY::ESC) && !bSettingOn_04)
	{
		//SettingUI
		m_pUI = new CPanelUI;
		...
		pResumeBtn->SetClickedCallBack(ResumeGame_04, 0, 0);
		...
		pLoadGameBtn->SetClickedCallBack(ChangeSceneLoad_04, 0, 0);
		...
		pExitGameBtn->SetClickedCallBack(ExitGame_04, 0, 0);
...
void CScene_Stage_04::Enter()
{
	...
	// TileObject 배치
	CreateTile(64, 64);
	wstring szname = L"tile\\Stage04_1.tile";
	LoadTile(szname);
