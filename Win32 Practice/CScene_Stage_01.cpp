...
void ChangeSceneLoad_01(DWORD_PTR, DWORD_PTR);
void ExitGame_01(DWORD_PTR, DWORD_PTR);
void ResumeGame_01(DWORD_PTR, DWORD_PTR);

bool bSettingOn_01 = false;
...
// 	}
	...
	if (KEY_TAP(KEY::ESC) && !bSettingOn_01)
	{
		//SettingUI
		m_pUI = new CPanelUI;
		...
		pResumeBtn->SetClickedCallBack(ResumeGame_01, 0, 0);
		...
		pLoadGameBtn->SetClickedCallBack(ChangeSceneLoad_01, 0, 0);
		...
		pExitGameBtn->SetClickedCallBack(ExitGame_01, 0, 0);
...
void CScene_Stage_01::Enter()
{
	...
	// TileObject 배치
	CreateTile(64, 64);
	wstring szname = L"tile\\Stage01Cry.tile";
	LoadTile(szname);
