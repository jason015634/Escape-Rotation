...
void ChangeSceneLoad_02(DWORD_PTR, DWORD_PTR);
void ExitGame_02(DWORD_PTR, DWORD_PTR);
void ResumeGame_02(DWORD_PTR, DWORD_PTR);

bool bSettingOn_02 = false;

CScene_Stage_02::CScene_Stage_02()
{
...
// 	}
	...
	if (KEY_TAP(KEY::ESC) && !bSettingOn_02)
	{
		//SettingUI
		m_pUI = new CPanelUI;
		...
		pResumeBtn->SetClickedCallBack(ResumeGame_02, 0, 0);
		...
		pLoadGameBtn->SetClickedCallBack(ChangeSceneLoad_02, 0, 0);
		...
		pExitGameBtn->SetClickedCallBack(ExitGame_02, 0, 0);
...
void CScene_Stage_02::Enter()
{
	...
	// TileObject 배치
	CreateTile(64, 64);
	wstring szname = L"tile\\Stage02.tile";
	LoadTile(szname);
