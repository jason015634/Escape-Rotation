...
void ChangeSceneLoad_05(DWORD_PTR, DWORD_PTR);
void ExitGame_05(DWORD_PTR, DWORD_PTR);
void ResumeGame_05(DWORD_PTR, DWORD_PTR);

bool bSettingOn_05 = false;

CScene_Stage_05::CScene_Stage_05()
{
...
// 	}
	...
	if (KEY_TAP(KEY::ESC) && !bSettingOn_05)
	{
		//SettingUI
		m_pUI = new CPanelUI;
		...
		pResumeBtn->SetClickedCallBack(ResumeGame_05, 0, 0);
		...
		pLoadGameBtn->SetClickedCallBack(ChangeSceneLoad_05, 0, 0);
		...
		pExitGameBtn->SetClickedCallBack(ExitGame_05, 0, 0);
...
void CScene_Stage_05::Enter()
{
	...
	// TileObject 배치
	CreateTile(64, 64);
	wstring szname = L"tile\\Stage05_1.tile";
	LoadTile(szname);
